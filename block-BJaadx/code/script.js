...
document.body.children[6].children[02];

// 3. Log the number (using console.log) of children of all the `li` element inside the ul with class `topics`

let liLength = document.body.children[5];
console.log(`children of all the li element inside the ul with class topics is ${liLength.children.length} `)
